    ...
    <div class="absolute top-[10px] left-[80px] z-[991] bg-transparent">
      ...
      >
        ...
        <div class="flex justify-start p-2">
          <div class="mr-3">
            <div
              class="mx-auto shadow-sm w-8 h-8 rounded-full bg-blue-600"
            ></div>
            <b>Ongoing</b>
          </div>
          <div class="mr-3">
          ...
          <div class="mr-3">
            <div
              class="mx-auto w-0 h-0 border-l-[20px] border-l-transparent border-b-[32px] border-b-blue-600 border-r-[20px] border-r-transparent"
            >
            </div>
            <b>Pending</b>
          </div>
