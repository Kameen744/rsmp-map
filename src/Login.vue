    ...
    >
      ...
      <div class="flext justify-between items-center mt-4">
        ...
        <p class="text-lg mb-4">
          The US-CDC, in collaboration with Sydani Group, aims to enhance the
          visibility of health care support by different implementing partners
          in Niger state.
        </p>
        <p class="text-lg mb-4">
          This support seeks to facilitate the strategic and optimal allocation
          of technical and financial partner resources to program areas within
          the state.
        </p>
        <p class="text-lg">
          Through this partner mapping dashboard, stakeholders can gain insights
          into existing partnerships, streamline collaboration efforts, and
          ensure optimal resource utilization for improved healthcare delivery.
        </p>
      </div>
